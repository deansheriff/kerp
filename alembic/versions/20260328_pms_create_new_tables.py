...
def upgrade() -> None:
    ...
    if not inspector.has_table("strategic_objective", schema="perf"):
        op.create_table(
            ...
            sa.Column("parent_objective_id", postgresql.UUID(as_uuid=True), nullable=True),
        ...
        op.create_index("idx_strat_obj_org", "strategic_objective", ["organization_id"], schema="perf")
    ...
    if not inspector.has_table("performance_contract", schema="perf"):
        op.create_table(
            ...
            sa.Column(
                ...
                postgresql.ENUM(
                    "MINISTERIAL", "DEPARTMENTAL", "INDIVIDUAL",
                    name="contract_type", schema="perf", create_type=False,
                ),
                nullable=False,
            ),
            sa.Column(
                ...
                postgresql.ENUM(
                    "DRAFT", "PENDING_SIGNATURE", "ACTIVE", "AMENDED", "COMPLETED", "CANCELLED",
                    name="contract_status", schema="perf", create_type=False,
                ),
                nullable=False,
            ),
        ...
        op.create_index("idx_contract_org", "performance_contract", ["organization_id"], schema="perf")
    ...
    if not inspector.has_table("monthly_review", schema="perf"):
        op.create_table(
            ...
            sa.Column(
                ...
                postgresql.ENUM(
                    "DRAFT", "SUBMITTED", "ACKNOWLEDGED",
                    name="monthly_review_status", schema="perf", create_type=False,
                ),
                nullable=False,
            ),
            ...
            sa.UniqueConstraint(
                "organization_id", "employee_id", "review_month",
        ...
        op.create_index("idx_review_org", "monthly_review", ["organization_id"], schema="perf")
    ...
    if not inspector.has_table("performance_improvement_plan", schema="perf"):
        op.create_table(
            ...
            sa.Column(
                ...
                postgresql.ENUM(
                    "DRAFT", "ACTIVE", "UNDER_REVIEW", "IMPROVED", "EXTENDED", "ESCALATED", "CLOSED",
                    name="pip_status", schema="perf", create_type=False,
                ),
                nullable=False,
            ),
            ...
            sa.Column(
                ...
                postgresql.ENUM(
                    "CLARITY", "SKILLS", "COMMITMENT", "HEALTH", "PERSONAL",
                    name="pip_cause_category", schema="perf", create_type=False,
                ),
                nullable=False,
            ),
            ...
            sa.Column(
                ...
                postgresql.ENUM(
                    "SATISFACTORY", "UNSATISFACTORY",
                    name="pip_outcome", schema="perf", create_type=False,
                ),
                nullable=True,
            ),
            sa.Column("outcome_date", sa.Date(), nullable=True),
            sa.Column("outcome_notes", sa.Text(), nullable=True),
            sa.Column("completion_letter_issued", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        ...
        op.create_index("idx_pip_org", "performance_improvement_plan", ["organization_id"], schema="perf")
    ...
    if not inspector.has_table("appraisal_appeal", schema="perf"):
        op.create_table(
            ...
            sa.Column(
                ...
                postgresql.ENUM(
                    "FILED", "UNDER_MEDIATION", "REFERRED_TO_COMMITTEE", "RESOLVED", "DISMISSED",
                    name="appeal_status", schema="perf", create_type=False,
                ),
                nullable=False,
            ),
            ...
            sa.Column("mediation_resolved", sa.Boolean(), nullable=False, server_default=sa.text("false")),
            sa.Column("committee_referral_date", sa.Date(), nullable=True),
            ...
            sa.Column(
                ...
                postgresql.ENUM(
                    "UPHELD", "PARTIALLY_UPHELD", "DISMISSED",
                    name="appeal_decision", schema="perf", create_type=False,
                ),
                nullable=True,
            ),
        ...
        op.create_index("idx_appeal_org", "appraisal_appeal", ["organization_id"], schema="perf")
    ...
    if not inspector.has_table("institutional_performance", schema="perf"):
        op.create_table(
            ...
            sa.Column(
                "institution_type",
                postgresql.ENUM(
                    "MINISTRY", "REGULATORY", "GENERAL_SERVICES",
                    "INFRASTRUCTURE", "SECURITY", "GOVT_COMPANY",
                    name="institution_type", schema="perf", create_type=False,
                ),
                nullable=False,
            ),
            sa.Column(
                ...
                postgresql.ENUM(
                    "DRAFT", "UNDER_REVIEW", "APPRAISED", "RECONCILED", "COMPLETED",
                    name="institutional_perf_status", schema="perf", create_type=False,
                ),
                nullable=False,
            ),
        ...
        op.create_index("idx_inst_perf_org", "institutional_performance", ["organization_id"], schema="perf")
    ...
    if not inspector.has_table("institutional_criteria_template", schema="perf"):
        ...
        op.create_index("idx_criteria_tmpl_org", "institutional_criteria_template", ["organization_id"], schema="perf")
    ...
    if not inspector.has_table("competency_assessment", schema="perf"):
        op.create_table(
            ...
            sa.Column("is_development_focus", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        ...
        op.create_index("idx_comp_assess_org", "competency_assessment", ["organization_id"], schema="perf")
    ...
    if not inspector.has_table("appraisal_outcome_action", schema="perf"):
        op.create_table(
            ...
            sa.Column(
                "action_type",
                postgresql.ENUM(
                    "REWARD", "PIP", "TRAINING", "TRANSFER", "PROMOTION",
                    "DEMOTION", "REMOVAL", "COUNSELING",
                    name="outcome_action_type", schema="perf", create_type=False,
                ),
                nullable=False,
            ),
            ...
            sa.Column(
                ...
                postgresql.ENUM(
                    "PENDING", "COMPLETED", "CANCELLED",
                    name="outcome_action_status", schema="perf", create_type=False,
                ),
                nullable=False,
            ),
            sa.Column("notes", sa.Text(), nullable=True),
        ...
        op.create_index("idx_outcome_org", "appraisal_outcome_action", ["organization_id"], schema="perf")
    ...
    # ------------------------------------------------------------------
    if (
        inspector.has_table("kpi", schema="perf")
        and inspector.has_table("strategic_objective", schema="perf")
    ):
        kpi_cols = {c["name"] for c in inspector.get_columns("kpi", schema="perf")}
        if "institutional_objective_id" in kpi_cols:
            existing_fks = {fk["name"] for fk in inspector.get_foreign_keys("kpi", schema="perf")}
            if "fk_kpi_institutional_objective" not in existing_fks:
                # Check if strategic_objective has a PK before adding FK
                so_pk = inspector.get_pk_constraint("strategic_objective", schema="perf")
