...
def upgrade() -> None:
    ...
    if not _table_exists(conn, "conversation"):
        op.create_table(
            ...
            sa.Column("conversation_type", postgresql.ENUM("DIRECT", "GROUP", "CHANNEL",
    ...
    if not _table_exists(conn, "conversation_participant"):
        op.create_table(
            ...
            sa.Column("role", postgresql.ENUM("MEMBER", "ADMIN", "OWNER",
    ...
    if not _table_exists(conn, "message"):
        op.create_table(
            ...
            sa.Column("message_type", postgresql.ENUM("TEXT", "SYSTEM", "FILE_ONLY",
