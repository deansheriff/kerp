...
MODULE_PERMISSIONS = [
    ...
    ("fleet:vehicles:read", "View vehicles"),
    ("fleet:vehicles:create", "Create vehicles"),
    ("fleet:vehicles:update", "Update vehicles"),
    ("fleet:maintenance:read", "View scheduled maintenance"),
    ("fleet:maintenance:create", "Schedule maintenance"),
    ("fleet:maintenance:update", "Update maintenance records"),
    ("fleet:fuel:read", "View fuel logs"),
    ("fleet:fuel:create", "Record fuel logs"),
    ("fleet:fuel:update", "Update fuel logs"),
