#!/usr/bin/env python3
"""
Bootstrap Instance Script — Provision a new single-tenant Kxmeleon ERP instance.
...
def generate_env(
    ...
    return textwrap.dedent(f"""\
        # =============================================================================
        # Kxmeleon ERP Instance: {org_name} ({org_code})
...
def generate_docker_compose(org_code: str) -> str:
    slug = org_code.lower()
    return textwrap.dedent(f"""\
        # Kxmeleon ERP Instance: {org_code}
        # Generated by bootstrap_instance.py
...
def generate_setup_script(org_code: str) -> str:
    ...
    return textwrap.dedent(f"""\
        ...
        # =====================================================================
        # Kxmeleon ERP Instance Setup: {org_code}
        # =====================================================================
        # This script:
        ...
        echo ""
        echo "=== Setting up Kxmeleon ERP instance: {org_code} ==="
        echo ""
...
def generate_readme(org_code: str, org_name: str, app_port: int) -> str:
    slug = org_code.lower()
    return textwrap.dedent(f"""\
        # Kxmeleon ERP — {org_name} ({org_code})
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Provision a new single-tenant Kxmeleon ERP instance.",
